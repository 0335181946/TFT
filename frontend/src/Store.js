...
function reducer(state, action){
    switch(action.type){
        ...
        case 'ADD_TO_CART':{
            ...
            const cartItems = existsItem ? state.cart.cartItems.map((item) => item._id === existsItem._id ? newItem : item) : [...state.cart.cartItems, newItem];
        ...
        case 'ADD_TO_WISH':{
            ...
            const wishItems = existsItem ? state.wish.wishItems.map((item) => item._id === existsItem._id ? newItem : item) : [...state.wish.wishItems, newItem];
